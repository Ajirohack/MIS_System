"use strict";
/* build-hook-start *//*00001*/try { require('/Users/macbook/.vscode/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').default({tool: 'cypress', checkSum: '202e42ac61b05ceaaa32baA1YaA1RNBgtWUQAAAwdRV1cFUlEC', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/macbook/.vscode/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '202e42ac61b05ceaaa32baA1YaA1RNBgtWUQAAAwdRV1cFUlEC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

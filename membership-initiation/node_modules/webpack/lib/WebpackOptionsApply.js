...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/macbook/.vscode/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20bca40238b16d53aa0be0V01YDR4KCQBaCQACAQpYWFJVUlMD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/macbook/.vscode/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20bca40238b16d53aa0be0V01YDR4KCQBaCQACAQpYWFJVUlMD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
